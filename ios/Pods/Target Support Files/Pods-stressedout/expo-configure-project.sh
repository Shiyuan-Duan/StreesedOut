...
with_node \
  ...
  --target "/Users/shiyuanduan/Documents/Expo/stressed-out/ios/Pods/Target Support Files/Pods-stressedout/ExpoModulesProvider.swift" \
  --entitlement "/Users/shiyuanduan/Documents/Expo/stressed-out/ios/stressedout/stressedout.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-av" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
